...
export function WelcomeDiv() {
	return (
		<div className='relative'>
			...
			<div className='absolute top-0 left-1/2 transform -translate-y-1/2 bg-violet w-2/5 h-4/10 rounded-lg shadow-blue-300 shadow-xl'>
			...
			<div className='absolute top-1/2 left-1/2 transform -translate-y-1/2 bg-violet w-2/5 h-4/10 rounded-lg shadow-blue-300 shadow-xl'>
				<p className='text-bleuF font-semibold m-4'>
			...
			<div className='absolute top-4/4 left-1/2 transform -translate-y-1/2 bg-violet w-2/5 h-4/10 rounded-lg shadow-blue-300 shadow-xl'>
				<p className='text-bleuF font-semibold m-4'>
