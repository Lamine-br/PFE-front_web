...
export function CandidatureSpontaneeE({
	...
	const handleExternalLinkClick = () => {
		window.open(url + candidature.chercheur.cv, "_blank");
	};
				...
				<div className='flex justify-between mt-6'>
					{candidature.chercheur ? (
						candidature.chercheur.cv ? (
							<div className='w-full'>
								...
								<object
									data={
										candidature.chercheur ? url + candidature.chercheur.cv : ""
									}
					...
					<div className='px-10 col-span-3 space-y-6 '>
						<div className='flex-col space-y-4'>
							...
							<div className='flex flex-col space-y-1'>
								<p className='text-bleuF text-sm'>Email</p>
								<p className=' text-bleuF font-bold'>
									{candidature.chercheur ? candidature.chercheur.email : ""}
								</p>
							</div>
							<div className='flex flex-col space-y-1'>
								<p className='text-bleuF text-sm'>Téléphone</p>
								<p className=' text-bleuF font-bold'>
									{candidature.chercheur ? candidature.chercheur.numero : ""}
								</p>
							</div>
						</div>
					</div>
